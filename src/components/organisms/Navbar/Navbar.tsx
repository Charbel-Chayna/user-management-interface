...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-[var(--color-primary)] p-4 flex items-center justify-between h-14 w-full">
      ...
      <div
        ...
        >
        <Button className="bg-white text-[var(--color-primary)] px-4 py-2 rounded cursor-pointer w-full sm:w-auto">
          Create User
        </Button>
